...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if (Member.id === message.author.id)
      return message.lineReply(`You Can't Kick Your Self!`);

    if (Member.id === client.user.id)
      return message.lineReply(`Please Don't Kick Me ;-;`);

    if (Member.id === message.guild.owner.user.id)
      return message.lineReply(`You Can't Kick Owner Of Server!`);
    ...
    if (!User.kickable)
      return message.lineReply(`I Can't Kick That Member!`);
